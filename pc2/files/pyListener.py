...
# define hosts
host0 = '192.168.10.180' 
host1 = '192.168.10.181'
host2 = '192.168.10.20'
host3 = '192.168.10.25' 
host4 = '192.168.10.52'
host5 = '192.168.10.90'
...
serversocket06 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
...
serversocket06.bind((host0, port6))
...
serversocket16.bind((host1, port6))
...
serversocket26.bind((host2, port6))
...
serversocket36.bind((host3, port6))
...
serversocket46 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
...
serversocket46.bind((host4, port6))
...
serversocket56 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
...
serversocket56.bind((host5, port6))
